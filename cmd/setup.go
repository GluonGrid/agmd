...
func runSetup(cmd *cobra.Command, args []string) error {
	...
	fmt.Println("  skill:managing-agmd — migration, tasks, directives reference for AI agents")
	fmt.Println("\nNext steps:")
	...
	fmt.Println("  agmd skill link managing-agmd    # Link the managing-agmd skill to your agent dirs")
