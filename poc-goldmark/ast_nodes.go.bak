...
type NewRuleBlock = NewItemBlock

var KindNewRuleBlock = KindNewItemBlock

func NewNewRuleBlock(name string) *NewRuleBlock {
	return NewNewItemBlock("rule", name)
}

// CustomSection represents :::custom ... :::end
type CustomSection struct {
	ast.BaseBlock
}

// KindCustomSection is the kind of CustomSection
var KindCustomSection = ast.NewNodeKind("CustomSection")

// Kind implements ast.Node
func (n *CustomSection) Kind() ast.NodeKind {
	return KindCustomSection
}

// Dump implements ast.Node
func (n *CustomSection) Dump(source []byte, level int) {
	ast.DumpHelper(n, source, level, nil, nil)
}

// NewCustomSection creates a new CustomSection
func NewCustomSection() *CustomSection {
