...
// RuleMeta represents frontmatter metadata
...
func (t *DirectiveTransformer) Transform(node *ast.Document, reader text.Reader, pc parser.Context) {
	ast.Walk(node, func(n ast.Node, entering bool) (ast.WalkStatus, error) {
		...
		case *NewItemBlock:
			// Keep as-is, will be detected by validate
		case *CustomSection:
			// Keep as-is, preserved during render
		}
...
func extractFrontmatter(data []byte) (*RuleMeta, []byte) {
